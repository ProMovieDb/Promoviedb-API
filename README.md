...
[![Version](https://img.shields.io/badge/version-1.0.2-green.svg)](https://github.com/promoviedb/promoviedb-api)
...
```gradle
dependencies {
    implementation 'com.promoviedb:promoviedb-api:1.0.2'
}
```
